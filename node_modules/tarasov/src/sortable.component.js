...
export var SortableComponent = (function (_super) {
    ...
    SortableComponent.prototype._onDragEndCallback = function (event) {
        ...
        //
        this.onDragEndCallback.emit({ dragData: this._dragDropService.dragData, mouseEvent: event });
    };
    SortableComponent.prototype._onDragEnterCallback = function (event) {
        if (this._sortableDataService.isDragged) {
            ...
            this.onDragEnterCallback.emit({ dragData: this._dragDropService.dragData, mouseEvent: event });
        }
    };
    ...
    SortableComponent.propDecorators = {
        ...
        'onDragEnterCallback': [{ type: Output, args: ["onDragEnter",] },],
